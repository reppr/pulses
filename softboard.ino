...
/*
   ...
   Read pin configuration and state, switch pins on/off
...
170	***********
   ...
   Example 4:  'a'	Display all instant values on analog inputs.
...
5	409	**************************
   ...
   Example 5:  '.'	Display info about all input pin configuration and states.
 ...
 pin 3	O  low
 pin 4	I  hi-z
*pin 5	I  pullup	// the * indicates selected pin
 pin 6	I  hi-z
 pin 7	I  hi-z
 pin 8	I  hi-z
 pin 9	I  hi-z
