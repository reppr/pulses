...
REGISTER_SCALE(ratios_octaves);			// 1
REGISTER_SCALE(ratios_octaves_fifths);		// 2
REGISTER_SCALE(ratios_octaves_fourths_fifths);  // 3
...
REGISTER_SCALE(ratios_int);			// 10
REGISTER_SCALE(overnotes);			// 11
REGISTER_SCALE(ratios_rationals);		// 12
REGISTER_SCALE(ratios_octaves_fourths);		// 13
