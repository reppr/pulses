...
//    ok,ok,ok,ok. ok, ok, ok, ok, ok, ok, ok, ok, ok,
    ...
    #undef GPIO_PINS
    #define GPIO_PINS	15
    gpio_pin_t click_pin[GPIO_PINS] =				//  ESP32_15_clicks_no_display	15 clicks TESTED
...
/* layout ESP-WROOM-32	heltec WIFI_Kit_32 (OLED)
  ...
  */
  ...
  // KALIMBA ESPxx versions:
    ...
    gpio_pin_t click_pin[GPIO_PINS] = { 32, 33, 14, 13, 23, 5, 17, 16};	//  ESP32  KALIMBA7_v2  8 clicks, 7 used

  #elif defined KALIMBA7_v1	// KALIMBA version 1 on ESP8266
    #undef GPIO_PINS
    #define GPIO_PINS	7	// number 8 unused, so far

    gpio_pin_t click_pin[GPIO_PINS] = {5,  4,  0,  2,  14, 13, 15 };	// ESP8266  KALIMBA7_v1  7 clicks, 3rd try
//  gpio_pin_t click_pin[GPIO_PINS] = {D1, D2, D3, D4, D5, D7, D8 };	// 7 clicks, 3rd try
    ...
    // ESP32s module 2x19 pins
    gpio_pin_t click_pin[GPIO_PINS] = { 32, 33, 14, 13, 23, 5, 17, 16};	//  GUITAR_v0 == KALIMBA7_v2  8 clicks
    ...
    #undef GPIO_PINS
    #define GPIO_PINS	15
    gpio_pin_t click_pin[GPIO_PINS] =				//  ESP32_15_clicks_no_display	15 clicks
      {0, 2, 4, 5, 13, 14, 15, 16, 17, 23, 27, 32, 33, 18, 19, };
   ...
   */
   ...
   gpio_pin_t click_pin[GPIO_PINS]={D1, D2, D3, D4, D5, D6, D7, D8};		// 8 clicks
  ...
  */
  ...
  gpio_pin_t click_pin[GPIO_PINS] =		// 32 clicks ;)
  ...
  gpio_pin_t click_pin[GPIO_PINS] =		// 16 clicks
    {38, 39, 40, 41, 42, 43, 44, 45,
