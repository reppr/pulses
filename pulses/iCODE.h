...
icode_t melody1[] = { NOTE_16, SOUNDSEP,1,6, 0,0,1,2,3,4, NOTE_8,LEGATO,5, PAUSE,5, NOTE_32,SEPARATO,6,7,8,7,6,5,4,3,2,1, NOTE_16,0, KILL, };  // *nice*	testing SOUNDSEP articulation

// use on major or minor scales
icode_t melody2[] = { NOTE_32, SOUNDSEP,1,6, /*I*/0,2,4,8,2,4,0,2, /*IV*/0,3,5,8,3,5,0,3, /*V*/-1,1,4,9,7,4,-1,1, /*I*/0,2,4,8,2,4,0,2,
		      KILL};

icode_t melody3[] = { NOTE_16, SOUNDSEP,1,6, /*I*/0,2,4,0,2,4, /*IV*/0,3,5,0,3,5, /*V*/1,4,6,-1,1,4, /*I*/0,2,4,0,2,4, KILL};


icode_t melody7[] = { MELODY_MODE,STACCISS,0, PAUSE,0, SEPARATO,NOTE_64,2,0,-1,-2,-3,-4, NOTE_16,STACCISS,-5,
