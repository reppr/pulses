...
unsigned int d4096_1536[] = {1,4096,1536, 0,0,0};
unsigned int d4096_1024[] = {1,4096,1024, 0,0,0};	// == 1/4	== ting4096
unsigned int d4096_768[] = {1,4096,768, 0,0,0};
unsigned int d4096_512[] = {1,4096,512, 0,0,0};
unsigned int d4096_384[] = {1,4096,384, 0,0,0};
unsigned int d4096_256[] = {1,4096,256, 0,0,0};
unsigned int d4096_192[] = {1,4096,192, 0,0,0};
unsigned int d4096_128[] = {1,4096,128, 0,0,0};
unsigned int d4096_96[] = {1,4096,96, 0,0,0};
unsigned int d4096_64[] = {1,4096,64, 0,0,0};
unsigned int d4096_48[] = {1,4096,48, 0,0,0};
unsigned int d4096_32[] = {1,4096,32, 0,0,0};
unsigned int d4096_24[] = {1,4096,24, 0,0,0};
...
unsigned int tumtumtumtum[] = {1,2048,2048/16, 1,16,1, 1,2048,2048/16, 1,16,1,
			       1,2048,2048/16, 1,16,1, 1,2048,2048/16, 0,0,0};

unsigned int tum8[] = {1,2048,2048/32, 1,32,1, 1,2048,2048/32, 1,32,1, 1,2048,2048/32, 1,32,1, 1,2048,2048/32, 1,32,1,
		       1,2048,2048/32, 1,32,1, 1,2048,2048/32, 1,32,1, 1,2048,2048/32, 1,32,1, 1,2048,2048/32, 0,0,0};

unsigned int tum8up[] = {1,2048,2048/32, 1,32,1,  1,2048,2048/32, 1,32,1,  1,2048,2048/32, 1,32,1,  1,2048,2048/32, 1,32,1,
			 1,4096,4096/32, 1,32,1,  1,8192,8192/32, 1,32,1,  1,16384,16384/32, 1,32,1,  1,16384,16384/32, 0,0,0};

//unsigned int tum16[] = {1,2048,2048/64, 1,64,1, 1,2048,2048/64, 1,64,1, 1,2048,2048/64, 1,64,1, 1,2048,2048/64,	1,64,1,
...
//
//unsigned int tum15u[] = {1,2048,2048/64, 1,64,1, 1,2048,2048/64, 1,64,1, 1,2048,2048/64, 1,64,1, 1,2048,2048/64,	1,64,1,
...
unsigned int mechanical[] = {4,4096,2, 2,4096,4, 1,4096*8,16, 1,4096*4,8, 1,4096*2,4, 2,4096,4, 1,4096,512, 2,4096,8, 4,4096,4, 8,4096,2, 1,4096*2,6, 0,0};

unsigned int mech2[] = {4,4096,1, 2,4096,3, 1,4096*8,8, 1,4096*4,4, 1,4096*2,2, 2,4096,3, /**/1,4096,127/**/, 1,4096*4,6, 1,4096*3,3, 8,4096,2, 1,4096*2,6, 0,0};

unsigned int mech255[] = {4,4096,1, 2,4096,3, 1,4096*8,8, 1,4096*4,4, 1,4096*2,2, 2,4096,3, /**/1,4096,255/**/, 1,4096*4,6, 1,4096*3,3, 8,4096,2, 1,4096*2,6, 0,0};

unsigned int mech511[] = {4,4096,1, 2,4096,3, 1,4096*8,8, 1,4096*4,4, 1,4096*2,2, 2,4096,3, /**/1,4096,511/**/, 1,4096*4,6, 1,4096*3,3, 8,4096,2, 4,4096,4, 0,0};

unsigned int mech1023[] = {4,4096,1, 2,4096,3, 1,4096*8,8, 1,4096*4,4, 1,4096*2,2, 2,4096,3, /**/1,4096,1023/**/, 1,4096*4,6, 1,4096*3,3, 8,4096,2, 4,4096,4, 0,0};

// TODO: TEST: and fix  with_pauses[]
unsigned int with_pauses[] = {1,1024,3, 1,2048,31, 1,4,1, 1,4096,63, 1,2018,15, 1,4,1, 1,4096,511, 1,8,1, 1,4096,11, 0,0};  // TODO: TEST

// made up for commit # 1500 ;)
unsigned int jiff_1500[] = {/*==mech2*/ 4,4096,1, 2,4096,3, 1,4096*8,8, 1,4096*4,4, 1,4096*2,2, 2,4096,3, 1,4096*4,6, 1,4096*3,3, 8,4096,2, 1,4096*2,6, /*new:*/ 1,2*4096,15, 1,4096,63, 1,2048,15,  1,32,1, 2,3*2048,15, 1,32,1,  1,4096,15, 1,32,1, 1,2*4096,15, 1,32,1, 8,9*2*4096,15, 1,32,1, 4,5*2*4096,15, 1,32,1, 3,4*2*4096,15, 1,32,1, 2,3*2*4096,63, 0,0};

unsigned int jiff_1500_2[] = {/*mech255*/ 4,4096,1, 2,4096,3, 1,4096*8,8, 1,4096*4,4, 1,4096*2,2, 2,4096,3,
...
unsigned int jiff_1500_3[] = {1,4096,3, 1,4,1,
			      4,4096,4,
			      2,3*4096,1536,
			      4,4096,8,
			      8,9*4096,1024,
