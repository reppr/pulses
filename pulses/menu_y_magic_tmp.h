...

{
  ...
  case 47:
    name = F("es netz vo eigenartige melodie wiegt über öis");
  ...
  case 50:
    name = F("slow simple melodic ostinato dance");
  ...
  case 110:
    name = F("another nice simple one");
  ...
  case 140:
    name = F("2019-02-02 ardour5 noname");
  ...
  case 160:
    name = F("rising ostinatos over rhythmic bordun");
