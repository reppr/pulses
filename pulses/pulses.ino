...
/* ******************** my_IDENTITY ************************* */
#include "peer_ID.h"	// peer_ID_t my_IDENTITY;
...
void setup_initial_HARDWARE_conf() {
  ...
  #elif defined ePaper213B73_BOARD_LILYGO_T5 || defined ePaper213BN_BOARD_LILYGO_BN
...
#endif
  MENU.out(F("\tV=voices for experiment (")); MENU.out(voices); MENU.out(F(")"));	// voices OBSOLETE? experiment only?
